...
# Change the number of DRAM ranks to 1
system.mem_ctrl.dram.ranks_per_channel = 1
system.mem_ctrl.dram.banks_per_rank = 8
# Change the row buffer size to 8kB
system.mem_ctrl.dram.device_rowbuffer_size = '8KiB'
