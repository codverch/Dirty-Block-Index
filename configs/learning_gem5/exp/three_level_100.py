""" This file creates a system with a CPU, separate L1 instruction and data caches, a L2 bus, unified L2 cache, unified L3 cache, a memory bus,
...
process.cmd = [args.binary, '-n', '100000000', '-i', 'bo', '-t', '10']
