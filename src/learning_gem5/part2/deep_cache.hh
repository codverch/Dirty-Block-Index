#ifndef __LEARNING_GEM5_DEEP_CACHE_DEEP_CACHE_HH__
#define __LEARNING_GEM5_DEEP_CACHE_DEEP_CACHE_HH__

#include <unordered_map>

#include "base/statistics.hh"
#include "mem/port.hh"
#include "params/DeepCache.hh"
...
namespace gem5
{
     ...
     */
    class DeepCache : public ClockedObject
    {
    private:
        /**
        ...
        private:
            ...
            /// The object that owns this object (DeepCache)
            DeepCache *owner;
        ...
        public:
             ...
             */
            CPUSidePort(const std::string &name, int id, DeepCache *owner) : ResponsePort(name, owner), id(id), owner(owner), needRetry(false),
             ...
             * This is a convenience function for the DeepCache to send pkts.
             *
             ...
             * from the DeepCache whenever it is unblocked.
             */
            void trySendRetry();
        ...
        public:
             ...
             * Constructor. Just calls the superclass constructor.
             */
            MemSidePort(const std::string &name, DeepCache *owner) : RequestPort(name, owner), owner(owner), blockedPacket(nullptr)
            {
            }
        ...
        /// Cache statistics
    protected:
        struct DeepCacheStats : public statistics::Group
        {
            DeepCacheStats(statistics::Group *parent);
    ...
    public:
        /** constructor
         */
        DeepCache(const DeepCacheParams &params);
...
#endif // __LEARNING_GEM5_DEEP_CACHE_DEEP_CACHE_HH__
